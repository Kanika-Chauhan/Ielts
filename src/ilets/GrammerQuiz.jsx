          ...
          <div className=" p-4  question  border  m-auto  bg-light ">
            ...
            {totalScore ? (
              ...
              <>
                ...
                <div className="text-center mainheading">
                  ...
                  {questions[currentqstn].option.map((val, i) => (
                    <button
                      type="button"
                      className={`btn d-block ms-5 btn-outline-dark m-2 ${clickedOption === i + 1 ? "checked" : null
                        }`}
                      key={i}
              ...
              <div className="text-center mt-3 ">
                ...
                <button onClick={GoHome} className="btn btn-primary ms-md-5 ms-2" >Go Home</button>
              </div>
